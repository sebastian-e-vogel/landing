        ...
        <div className="SixthSection">
          ...
          <div className="Container-SixthText">
            <div className="Text-SixthSection">
              ...
              <p className="Number-SixthSection">Para evitar las engorrosas filas desarrollamos un sistema de reserva online donde los usuarios podrán realizar una reserva o pagar el servicios que desean tanto con tarjeta de crédito como en efectivo.</p>
              <p className="TextBold-SixthSection">Los usuarios tendrán todos los detalles de la misma:</p>
